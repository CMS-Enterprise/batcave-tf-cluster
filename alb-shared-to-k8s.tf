  ...
  dynamic "default_action" {
    ...
    content {
      ...
      fixed_response {
        ...
        message_body = try(var.alb_shared_restricted_hosts[0], "") == "deny-by-default.example.com" ? "Misconfigured load balancer.  Contact infrstructure team for assistance." : "Unacceptable Host"
        status_code  = "403"
      }
    }
  }
